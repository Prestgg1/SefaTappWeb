<template>
  <div
    class="max-w-md w-full mx-auto   rounded-2xl p-6 sm:p-8"
  >
    <h2
    ...
    <form @submit.prevent="submitLogin" class="space-y-5">
      <div>
        ...
        <input
          ...
          class="mt-1 w-full p-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary outline-none transition"
        />
      </div>
      ...
      <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4">
        <button
          @click="$emit('close')"
          type="button"
          class="w-full sm:w-auto px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition"
        >
          Ləğv Et
        </button>
