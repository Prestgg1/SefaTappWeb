<template>
    <header
      class="sticky top-0 z-50 bg-white/80  backdrop-blur-sm border-b border-gray-200  transition-colors"
    >
      <div class="container mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-8">
          <NuxtLink
            to="/#home"
            class="text-sm font-medium text-gray-600  hover:text-teal-600 dark:hover:text-teal-400 transition-colors"
          >
            Ana Səhifə
          </NuxtLink>
          <NuxtLink
          ...
          <NuxtLink
            to="/blogs"
            class="text-sm font-medium text-gray-600  hover:text-teal-600 dark:hover:text-teal-400 transition-colors py-2"
          >
            Bloglar
          </NuxtLink>
          <NuxtLink
        ...
        <div class="flex items-center gap-4">
          ...
          <!-- Mobile Menu Button -->
          <button
            class="md:hidden p-2 text-gray-600  hover:text-teal-600 dark:hover:text-teal-400"
      ...
      <Teleport to="body">
        ...
        >
          <div
            class="bg-white  rounded-2xl shadow-xl max-w-md w-full p-8 text-center animate-pop"
          >
