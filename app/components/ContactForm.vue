<template>
    <section id="support" class="py-16 sm:py-20 lg:py-24">
      <div class="container mx-auto px-4 sm:px-6">
        <div class="max-w-4xl mx-auto">
          <div class="bg-white  rounded-xl lg:rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10">
            
            <div class="text-center mb-8 lg:mb-10">
              <div class="inline-flex items-center justify-center w-16 h-16 bg-teal-100  rounded-full mb-4">
                <Icon name="mdi:email" class="material-symbols-outlined text-teal-600  text-2xl"/>
              </div>
            ...
            <div v-if="isSuccess" class="mb-6 p-4 bg-green-50  border border-green-200  rounded-lg">
              <div class="flex items-center gap-3">
                <Icon name="mdi:email" class="material-symbols-outlined text-green-600  text-2xl"/>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      :class="[
                        'w-full px-4 py-3 border rounded-lg bg-white  text-gray-900  placeholder-gray-500  focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200',
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      :class="[
                        'w-full px-4 py-3 border rounded-lg bg-white  text-gray-900  focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200',
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="5"
                    :class="[
                      'w-full px-4 py-3 border rounded-lg bg-white  text-gray-900  placeholder-gray-500  focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 resize-none',
                ...
                <div class="bg-gray-50  rounded-lg p-4">
                  <div class="flex items-start gap-3">
                    <Icon name="mdi:privacy-tip" class="text-teal-600  text-lg mt-0.5"/>
                    <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8 text-center sm:text-left max-w-4xl mx-auto">
                <div class="flex flex-col sm:flex-row items-center gap-3">
                  <div class="w-10 h-10 bg-teal-100  rounded-full flex items-center justify-center">
                    <Icon name="mdi:phone" class="text-teal-600  text-lg"/>
                  </div>
                  <div>
                    <p class="font-medium text-gray-900 ">Telefon</p>
                    <p class="text-sm text-gray-600 ">+994 51 942 33 75</p>
                  </div>
                </div>
    
                <div class="flex flex-col sm:flex-row items-center gap-3">
                  <div class="w-10 h-10 bg-teal-100  rounded-full flex items-center justify-center">
                    <Icon name="mdi:mail" class=" text-teal-600  text-lg"/>
                  </div>
                  <div>
                    <p class="font-medium text-gray-900 ">E-mail</p>
                    <p class="text-sm text-gray-600 ">prestgg56@gmail.com</p>
                  </div>
                </div>
    
                <div class="flex flex-col sm:flex-row items-center gap-3">
                  <div class="w-10 h-10 bg-teal-100  rounded-full flex items-center justify-center">
                    <Icon name="mdi:schedule" class="text-teal-600  text-lg"/>
                  </div>
                  <div>
                    <p class="font-medium text-gray-900 ">İş Saatları</p>
                    <p class="text-sm text-gray-600 ">24/7 Dəstək</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.add({
        title: "Xəta baş verdi. Yenidən cəhd edin.",
        color:'error'
      })
